...
export default function UserLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md animate-slide-up">
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full text-sm font-medium">
          ...
          <Card className="border-0 shadow-xl bg-white dark:bg-slate-700">
            <CardContent className="p-8">
              ...
              <p className="text-gray-500 dark:text-gray-300 text-center mb-8">
                Pristupite svom parkingu
              </p>

              <button
                type="button"
                onClick={fillDemo}
                className="w-full flex items-center gap-3 p-4 mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl text-left hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
              >
