    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/login"
                className="text-sm px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors"
              >
                Prijava
              </Link>
              <Link
      ...
      <main className="pt-16 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Naslov */}
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 animate-slide-up">
            Kontrola pristupa{" "}
          ...
          {/* Opis */}
          <p
            className="text-base sm:text-lg text-gray-600 mb-8 max-w-2xl mx-auto animate-slide-up"
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <Link
              href="/admin/login"
              className="group relative bg-white rounded-2xl p-4 border-2 border-gray-100 hover:border-primary-500 transition-all duration-300 hover:shadow-xl animate-slide-up"
            ...
            >
              ...
              <p className="text-gray-500 mb-6 text-base">
                Upravljanje uređajima, grupama korisnika i pregled svih
                aktivnosti.
              </p>
            ...
            <Link
              href="/login"
              className="group relative bg-white rounded-2xl p-4 border-2 border-gray-100 hover:border-blue-500 transition-all duration-300 hover:shadow-xl animate-slide-up"
            ...
            {[
              {
                ...
                description:
                  "Dodajte tablice svojih vozila za automatski pristup parkingu.",
              },
              {
                title: "Pristup za goste",
                description:
                  "Generišite PIN ili link za goste sa vremenskim ograničenjem.",
              },
              {
                title: "Praćenje aktivnosti",
                description:
                  "Vidite ko je i kada pristupio parkingu u realnom vremenu.",
              },
            ].map((feature, idx) => (
              <div
                key={feature.title}
