...
const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = 'default', hover = false, ...props }, ref) => {
    const variants = {
      default: 'bg-white dark:bg-slate-800 border border-gray-100 dark:border-gray-700 shadow-sm',
      bordered: 'bg-white dark:bg-slate-800 border-2 border-gray-200 dark:border-gray-600',
      elevated: 'bg-white dark:bg-slate-800 shadow-lg dark:shadow-slate-900/50',
    }
